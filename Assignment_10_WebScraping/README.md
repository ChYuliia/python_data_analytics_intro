...
\* \*\*Reference Curriculum:\*\* CIS 2260 / Python for Data Analysis / Networked Programs \& Web Scraping
...
Assignment\_10\_WebScraping/

├── docs/

│   └── Assignment\_10\_WebScraping.pdf       # Exported assignment documentation

├── notebooks/

│   └── Assignment\_10\_WebScraping.ipynb     # Executed analysis notebook
...
&#x20; Established secure HTTP GET connections with custom user-agent headers and robust error/exception management (`requests.get()` and `raise\_for\_status()`).
...
&#x20;  cd python\_data\_analytics\_intro/Assignment\_10\_WebScraping
